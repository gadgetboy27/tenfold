    ...
    <div className="max-w-4xl">
      ...
      <div className="grid grid-cols-5 gap-8">
        ...
        <div className="col-span-3 space-y-8">
          ...
          <section>
            <h2 className="text-sm font-semibold text-foreground mb-4 flex items-center gap-2">
              <Palette className="w-4 h-4 text-muted-foreground" /> Brand
              Colours
            </h2>
            <div className="space-y-4">
              <ColorField
                ...
                onChange={(v) => setKit((k) => ({ ...k, primary_color: v }))}
              />
              <ColorField
                label="Secondary"
                value={kit.secondary_color}
                onChange={(v) => setKit((k) => ({ ...k, secondary_color: v }))}
              />
              <ColorField
                label="Accent"
                value={kit.accent_color}
                onChange={(v) => setKit((k) => ({ ...k, accent_color: v }))}
              />
            </div>
          </section>
          ...
          <section>
            ...
            <Input
              value={kit.tagline}
              onChange={(e) =>
                setKit((k) => ({ ...k, tagline: e.target.value.slice(0, 200) }))
              }
              placeholder="e.g. Powering the future of AI marketing"
              className="bg-background"
            />
            <p className="text-xs text-muted-foreground mt-1.5">
              {kit.tagline.length}/200 · stamped on composed exports
            </p>
          </section>
          ...
          <div className="sticky top-0 space-y-3">
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${kit.primary_color}cc, ${kit.secondary_color}cc)`,
                }}
              >
                {kit.logo_url && (
                  <Image
                    ...
                    width={120}
                    height={32}
                    className="absolute top-3 left-3 h-8 w-auto object-contain drop-shadow-lg"
                  />
                )}
                <div
