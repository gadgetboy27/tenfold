  ...
  return (
    <div className={`relative w-full ${aspectClass[aspectRatio] ?? 'aspect-square'} rounded-xl overflow-hidden border border-border bg-card`}>
      <motion.div
        ...
        style={{
          background: 'linear-gradient(120deg, #0f0f0f 0%, #1a1040 30%, #2d1b69 50%, #1a1040 70%, #0f0f0f 100%)',
    ...
    <div className="h-full flex flex-col items-center justify-center pb-32 pt-8 relative">
      ...
      <div className="relative w-full max-w-5xl mx-auto px-6" style={{ zIndex: 2 }}>
        <div className={`grid ${gridCols} gap-5`}>
          {isGenerating
            ? <GeneratingCard aspectRatio={aspectRatio} stage={generationStage || 'Submitting your prompt…'} elapsed={generationElapsed} />
